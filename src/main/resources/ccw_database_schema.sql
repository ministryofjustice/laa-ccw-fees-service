...
(
    ...
    CONSTRAINT fk_mcc_matter_codes_1_matter_code_1 FOREIGN KEY (MATTER_CODE_1) REFERENCES MATTER_CODES_1(MATTER_CODE_ID),
    CONSTRAINT fk_mcc_matter_codes_2_matter_code_2 FOREIGN KEY (MATTER_CODE_2) REFERENCES MATTER_CODES_2(MATTER_CODE_ID)
);
...
(
    ...
    CONSTRAINT fk_csc_matter_codes_1_matter_code_1 FOREIGN KEY (MATTER_CODE_1) REFERENCES MATTER_CODES_1(MATTER_CODE_ID),
    CONSTRAINT fk_csc_case_stages_case_stages FOREIGN KEY (CASE_STAGES) REFERENCES CASE_STAGES(CASE_STAGE_ID)
);
...
(
    ...
    CONSTRAINT pk_fix_fixed_fee_id PRIMARY KEY (fixed_fee_id),
    CONSTRAINT fk_fix_case_stages_case_stage FOREIGN KEY (CASE_STAGE) REFERENCES CASE_STAGES(CASE_STAGE_ID),
    CONSTRAINT fk_fix_level_codes_level_code FOREIGN KEY (LEVEL_CODE) REFERENCES LEVEL_CODES(LEVEL_CODE_ID),
    CONSTRAINT fk_fix_provider_locations_provider_location FOREIGN KEY (PROVIDER_LOCATION) REFERENCES PROVIDER_LOCATIONS(PROVIDER_LOCATION_ID)
);