...
(
    ...
    CONSTRAINT fk_matter_codes_2_matter_code_2 FOREIGN KEY (MATTER_CODE_2) REFERENCES MATTER_CODES_2(MATTER_CODE_ID)
);
...
(
    ...
    CONSTRAINT fk_matter_codes_1_matter_code_1 FOREIGN KEY (MATTER_CODE_1) REFERENCES MATTER_CODES_1(MATTER_CODE_ID)
    CONSTRAINT fk_case_stages_case_stages FOREIGN KEY (CASE_STAGES) REFERENCES CASE_STAGES(CASE_STAGE_ID)
);
